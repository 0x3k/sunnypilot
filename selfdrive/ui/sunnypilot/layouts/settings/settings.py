...
from openpilot.selfdrive.ui.sunnypilot.layouts.settings.tailscale import TailscaleLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.TAILSCALE: PanelInfo(tr_noop("Tailscale"), TailscaleLayout(), icon="icons/link.png"),
